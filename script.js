...
async function fetchDiscordUser(token) {
    ...
    try {
        ...
        if (user.username) {
            ...
            document.getElementById('login-subtitle').innerText = "Identità confermata! Inserisci la password per entrare.";
            ...
            // Focus password con un piccolo ritardo per l'animazione
            setTimeout(() => {
        ...
        showModal("Errore", "Impossibile connettersi a Discord. Riprova.");
    }
}
