...
async function checkStaffLogin() {
    ...
    if (!user) { alert("Inserisci il tuo nome Discord!"); return; }
    if (btn) { btn.disabled = true; btn.innerText = "ACCESSO IN CORSO..."; }
    ...
    try {
        ...
        if (pass === correctPass) {
            currentUser = { 
                name: user, 
                pfp: "https://cdn.discordapp.com/attachments/1476597416424898711/1502331326731124847/Gemini_Generated_Image_v6yt1xv6yt1xv6yt-removebg-preview.png" 
            };
...
// Alias per compatibilità HTML
function handleLogin() { checkStaffLogin(); }
