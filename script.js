...
async function fetchDiscordUser(token) {
    ...
    if (btn) btn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> IDENTIFICAZIONE...';
    ...
    try {
        ...
        if (user.username) {
            ...
            document.getElementById('login-subtitle').innerText = "Inserisci la password per confermare l'accesso.";
            ...
            // Focus password for user convenience
            setTimeout(() => document.getElementById('login-pass').focus(), 100);
        }
    } catch (e) {
        console.error("Errore Discord OAuth:", e);
        if (btn) btn.innerHTML = '<i class="fab fa-discord"></i> IDENTIFICATI CON DISCORD';
    }
}
...
function resetLoginStep() {
    ...
    document.getElementById('login-title').innerText = "WASHINGTON RP";
    document.getElementById('login-subtitle').innerText = "Accesso Staff Riservato";
    document.getElementById('login-avatar').src = "assets/logo.png";
    document.getElementById('login-avatar').style.border = "none";
    document.getElementById('login-user').value = "";
    document.getElementById('login-pass').value = "";
    discordTempAvatar = null;
}
